...
namespace WindowsFormsApp1
{
    public partial class GradesForm : Form
    {
        ...
        private Dictionary<string, Subjects> subjids = new Dictionary<string, Subjects>();
        ...
        // --------INITIALIZING THE FORM WE ADD INFORMATION AND ETC ====================
        
        // ________________________________CHOICES BOX ______________________
        ...
        // _____________ Button Clicks :____________________
        ...
        async private void add_csv_Click(object sender, EventArgs e)
        {
            ...
            {
                var j = await parser.addGradeCsv(subjids[subject.Text].subject_id.ToString(), ofd.FileName);
       ...
       async private void downloadbutt_Click(object sender, EventArgs e)
        {
            ...
            if(save.ShowDialog() == DialogResult.OK)
            {
                ...
                var subj = subjids[subject.Text];
                var students = await parser.getStudents(classroom: subj.classroom.id.ToString());
                SLDocument workbook = new SLDocument();


                workbook.SetCellValue("A1", "ids");
                workbook.SetCellValue("B1", "grade");


                int pos = 2;
                foreach (var student in students)
                {
                    workbook.SetCellValue($"A{pos}",student.student_id);
                    pos++;
                }
        ...
        async private void searchButt_Click(object sender, EventArgs e)
        {
            ...
            var student = await parser.getStudents(student_id: idTextBox.Text);

            if (student.Count == 0)
                {
                    MessageBox.Show("Couldn't Find a student with that id");
                    return;
                }

            StudentCardForm form = new StudentCardForm(student.First());
            form.Show();
        ...
        async private void GradesForm_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Button download_butt = new Button();
                download_butt.Text = "Download Student List";
                download_butt.AutoSize = true;
                download_butt.BackColor = Color.FromArgb(36, 160, 237);
                download_butt.ForeColor = Color.White;
                download_butt.FlatStyle = FlatStyle.Flat;
                download_butt.Font = new Font("Lato", 16);
                download_butt.Location = new Point(60, 160);
                download_butt.Click += new EventHandler(downloadbutt_Click);
                ...
                search_stud.Click += new EventHandler(searchButt_Click);

                Label idlabel = new Label();
                idlabel.Text = "Search student by id :";
                idlabel.Font = new Font("Lato", 16);
                idlabel.Location = new Point(70, 85);
                idlabel.Size = new Size(230, 23);

                idTextBox.Size = new Size(240, 25);
                idTextBox.Location = new Point(55, 125);
                idTextBox.Font = new Font("Lato", 17);
                ...
                add_panel.Controls.Add(download_butt);


                search_panel.Controls.Add(search_panel_title);
                search_panel.Controls.Add(search_stud);
                search_panel.Controls.Add(idlabel);
                search_panel.Controls.Add(idTextBox);
